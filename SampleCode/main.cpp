...
int main(int argc, char *argv[]) {
    ...
    {
        benchmark_files.push_back(argv[1]);
    }

    for (auto benchmark_file : benchmark_files)
    {
        string benchmark_path = "../../evrp-benchmark-set/";
        benchmark_path += benchmark_file;
        problem_instance = (char*)benchmark_path.c_str();
